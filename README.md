...
To install using binary packages, simply run: `sysutils/py-iocage`

If cloning the repo directly, ensure you have python 2.7,
cd into the cloned directory and run `pip install .` as root.
